...
// coding agents (Claude Code, Codex, Copilot). It mirrors the happy-cli AgentBackend
...
// Supported types: "claude", "codex", "copilot".
func New(agentType string, cfg Config) (Backend, error) {
	...
	default:
		return nil, fmt.Errorf("unknown agent type: %q (supported: claude, codex, copilot)", agentType)
	}
}
